...
import { AppstoreAddOutlined, HomeOutlined, LogoutOutlined } from '@ant-design/icons';
    ...
    <Layout>
      <Header style={{ display: 'flex', alignItems: 'center', backgroundColor: 'white' }}>
       <div className="demo-logo" style={{ backgroundColor: 'white' }}>
          <Image src='' width={70} preview={false} />
        </div>
        <div style={{ backgroundColor: 'white' ,position:'absolute',right:20 }}>
        <LogoutOutlined style={{fontSize:25}}></LogoutOutlined>
        </div>
        <Menu
          mode="horizontal"
