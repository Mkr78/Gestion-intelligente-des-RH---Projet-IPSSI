...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const columns = [
        {
            title: <span className="custom-table-span-column">ID </span>,
            key: '_id',
            dataIndex: '_id',
            render: (_id) => (
              <span>
        ...
        {
            title: <span className="custom-table-span-column"></span>,
            key: 'actions',
            render: (text, record) => (
              <span>
                <EyeOutlined onClick={() => handleViewProduct(record)} style={{color:'black', fontSize:18, marginRight:2, cursor:'pointer'}} />
                <DeleteOutlined onClick={() => { setProductToDelete(record); setModalVisible(true); }} style={{color:'black', fontSize:18, marginRight:2, cursor:'pointer'}} />
            ...
            <div style={{ padding: 10 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', width: '77%' }}>
                    ...
                    <Modal
                        ...
                        width={1000}
                    >
                        <h3 style={{marginBottom:15,color:'black'}}>Product details</h3>
                        {selectedProduct ? (
                            <div>
            ...
            <Row gutter={24}>
                <Col xs={24} sm={24} md={24}>
                    <div style={{ display: 'flex' }}>
                        ...
                        {/* <Card className='custom-card-clients-overview'>
                            <p className='title-card'>Accepted Candidates</p>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '250px' }}>
                        ...
                        {/* <Card className='custom-card-clients-overview'>
                            <p className='title-card'>Refused Candidates</p>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '250px' }}>
                                <p className='content-card'>{totalConsole}</p>
                                <div className='circle-icon'>
                                    <UserOutlined style={{ fontSize: 24, color: 'black' }} />
